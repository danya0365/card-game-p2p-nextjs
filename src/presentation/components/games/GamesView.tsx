...
const games = [
  ...
  },
  {
    ...
    name: "ไพ่แคง",
    nameEn: "Kang",
    description: "เกมไพ่ไทยดั้งเดิม เปรียบไพ่ 3 ใบ ใครแต้มสูงสุดชนะ",
    players: "2-6 คน",
    duration: "5-10 นาที",
    difficulty: "ง่าย",
    icon: "♥️",
  ...
  },
  {
    ...
    description: "เกมไพ่ระดับโลก ใช้กลยุทธ์และจิตวิทยาเอาชนะคู่แข่ง",
    players: "2-9 คน",
    duration: "30-60 นาที",
    difficulty: "ยาก",
    icon: "♦️",
  ...
  },
  {
    ...
    name: "แบล็คแจ็ค",
    nameEn: "Blackjack / 21",
    description: "เกมไพ่ 21 แข่งกับเจ้ามือ ใครใกล้ 21 แต้มมากที่สุดชนะ",
    players: "1-7 คน",
    duration: "5-15 นาที",
    difficulty: "ง่าย",
    icon: "🃏",
